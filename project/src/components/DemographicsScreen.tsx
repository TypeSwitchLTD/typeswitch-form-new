        ...
        <div className="min-h-screen bg-red-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg shadow-xl p-8 max-w-lg text-center">
                ...
                <p className="text-gray-600">
                    Translation data for the 'Demographics' screen could not be loaded.
                </p>
            </div>
        </div>
    );
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold text-sm hover:bg-blue-700 transition"
          >
            {t.continueButton}
          </button>
        </div>
